...
describe("computeRecipe — totals", () => {
  ...
  it("computes total_flour_g from items with role=flour", () => {
    const r: Recipe = { schema_version: "1.0", items: [{ ingredient_id: "bread_flour", grams: 500 }, { ingredient_id: "water_tap", grams: 320 }] };
  ...
  it("honors a custom bake_loss_pct", () => {
    const r: Recipe = { schema_version: "1.0", bake_loss_pct: 10, items: [{ ingredient_id: "bread_flour", grams: 500 }, { ingredient_id: "water_tap", grams: 300 }] };
