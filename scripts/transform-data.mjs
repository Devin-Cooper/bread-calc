...
const FILES = ["ingredients", "flours", "bb_pdc20_recipes", "bb_pdc20_templates", "machines", "defaults"];
...
writeFileSync("dist/lib/data/index.d.ts",
  `import type { Ingredient, Flour, BBPDC20Recipe, Machine, Defaults } from "../index.js";
